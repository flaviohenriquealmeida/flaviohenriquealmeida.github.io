...
>*A função original divisivelPor que antes recebia dois parâmetros, agora retorna uma função que recebe um parâmetro apenas, simplificando a sua chamada em termos de parâmetros passados. Cara, muito obrigado*.
